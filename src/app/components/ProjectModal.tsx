...
export default function ProjectModal({setIsModal,isModal,content}:ProjectModalProps): ReturnType<FC> {
  return <div className={styles.projects__modal}>
    ...
    <div className={content.gitHub ? styles.projects__modal__container : styles.projects__modal__container_v2}>
      {content.img0 ? <img src={content.img0.src} alt="insta" className={styles.projects__modal__img} /> : ""}
      <p className={styles.projects__modal__text}>{content.text0}</p>
      {content.img1 ? <img src={content.img1.src} alt="insta" className={styles.projects__modal__img} /> : ""}
      <p className={styles.projects__modal__text}>{content.text1}</p>
      {content.gitHub ? <div className={styles.projects__modal__btns}>
